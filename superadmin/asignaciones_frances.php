<?php
// superadmin/asignaciones_frances.php
...
// Obtener TODAS las asignaciones y filtrar para mostrar solo Francés
...
foreach ($todasAsignaciones as $key => $grupo) {
    ...
    foreach ($grupo as $asignacion) {
        if ($asignacion['materia_nombre'] === 'Francés') {
...
<main class="container">
  ...
  <div style="display:grid; grid-template-columns:1fr 1.8fr; gap:1.5rem; align-items:start;">
    ...
    <section class="card">
      <h2 class="section-title">➕ Nueva asignación - Francés</h2>
    ...
    <section>
      ...
      <?php if (empty($asignaciones)): ?>
        <p class="empty-state">Aún no hay asignaciones de Francés para este ciclo.</p>
      <?php else: ?>
